...
public class Task1 extends Configured implements Tool {
	public int run(String[] arg) throws Exception {
		...
		// Point to Jar
		conf.set("mapred.jar",
				"file:///users/level4/1003648b/BD4/ax2/BD4-2/Q1A.jar");
		// Setup job
